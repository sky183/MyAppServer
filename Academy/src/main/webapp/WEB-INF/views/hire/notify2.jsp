...
<body>
	...
	<div id="bottomWrap">
		...
		<div class="listSearchBox">
			<label for="queryStr2" class="hide">SEARCH</label> <select class="select">
				<option>제목</option>
				<option>내용</option>
