...
<body>
	...
	<div id="writeWrap">
		<div
			style="padding-top: 40px; padding-bottom: 22px; font-size: 22px; font-weight: bold; text-align: center;">게시글
			작성</div>
			...
			<table class="board_view">
				<tbody>
					...
					<tr>
						...
						<td class="td2"><input type="date" id="date" name="date"></input>
						</td>
					</tr>
				</tbody>
			</table>
...
$(document).ready(function(){
	...
	$('#write').click(function() {
		var hireVO = new FormData($("#frm")[0]); // serialize() : 입력된 모든Element(을)를 문자열의 데이터에 serialize 한다.
